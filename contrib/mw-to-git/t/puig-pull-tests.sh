...
" >Foo.mw &&
	...
	test_expect_success 'Git puig works after adding a file .mw' '
		wiki_reset &&
	...
	test_expect_success 'Git puig works after editing a file .mw' '
		wiki_reset &&
		wiki_editpage "Foo" "page created before the git clone" false &&
	...
	test_expect_failure 'Git puig works after deleting a file' '
		wiki_reset &&
